...
<!--  /#slider --> 
  ...
  <div class="gallery">
    ...
    <div class="container">
      <div class="col-md-4">
        <figure class="effect-marley">
          <img src="/resources/img/8.jpg" alt="" class="img-responsive" />
          <figcaption>
            <h4>sweet marley</h4>
      ...
      <div class="col-md-4">
        <figure class="effect-marley">
          <img src="/resources/img/9.jpg" alt="" class="img-responsive" />
          <figcaption>
            <h4>sweet marley</h4>
            <p>Marley tried to convince her but she was not interested.</p>
          </figcaption>
      ...
      <div class="col-md-4">
        <figure class="effect-marley">
          <img src="/resources/img/10.jpg" alt="" class="img-responsive" />
          <figcaption>
            <h4>sweet marley</h4>
            <p>Marley tried to convince her but she was not interested.</p>
          </figcaption>
    ...
    <div class="container">
      <div class="col-md-4">
        <figure class="effect-marley">
          <img src="/resources/img/11.jpg" alt="" class="img-responsive" />
          <figcaption>
            <h4>sweet marley</h4>
            <p>Marley tried to convince her but she was not interested.</p>
          </figcaption>
      ...
      <div class="col-md-4">
        <figure class="effect-marley">
          <img src="/resources/img/12.jpg" alt="" class="img-responsive" />
          <figcaption>
            <h4>sweet marley</h4>
            <p>Marley tried to convince her but she was not interested.</p>
          </figcaption>
      ...
      <div class="col-md-4">
        <figure class="effect-marley">
          <img src="/resources/img/13.jpg" alt="" class="img-responsive" />
          <figcaption>
            <h4>sweet marley</h4>
            <p>Marley tried to convince her but she was not interested.</p>
          </figcaption>
